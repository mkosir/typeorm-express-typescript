...
- Contract first REST API design:
  ...
  - Consistent error [response](./src/utils/response/CustomError.ts). Your frontend will always receive consistent schema for error response and always know how to deal with one if thrown in `try...catch` statement 💪
